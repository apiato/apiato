...
namespace App\Ship\Features\Serializers;

use InvalidArgumentException;
use League\Fractal\Pagination\PaginatorInterface;
use League\Fractal\Resource\ResourceInterface;

class JsonApiSerializer extends \League\Fractal\Serializer\ArraySerializer
{
    protected $baseUrl;
    ...
    public function collection($resourceKey, array $data)
    {
        $resources = [];
        // dd($data);
        if (empty($resourceKey) && !empty($data) && isset(current($data)['object'])) {
            $resourceKey = current($data)['object'];
        }
        foreach ($data as $resource) {
            if (array_key_exists('object', $resource)) {
    ...
    public function item($resourceKey, array $data)
    {
        ...
        if (empty($resourceKey) && array_key_exists('object', $data)) {
            $resourceKey = $data['object'];
        }
     ...
     * @return array
     */
    public function buildRelationships($includeKey, $relationships, $includeObject, $key)
    {
