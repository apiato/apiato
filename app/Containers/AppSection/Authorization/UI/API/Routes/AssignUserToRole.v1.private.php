...
use App\Containers\AppSection\Authorization\UI\API\Controllers\AssignUserToRoleController;
use Illuminate\Support\Facades\Route;

Route::post('roles/assign', [AssignUserToRoleController::class, 'assignUserToRole'])
